    ...
    <section id="pricing" className="bg-white py-24 px-5 border-t border-neutral-200">
      <div className="max-w-6xl mx-auto">
        <div className="mb-12 flex flex-col md:flex-row md:items-end md:justify-between gap-6">
          ...
          <div className="inline-flex items-center gap-1 bg-neutral-100 rounded-lg p-1 self-start md:self-auto">
            <button
              onClick={() => setAnnual(false)}
              className={`px-4 py-2 text-sm font-medium rounded-md transition-all ${!annual ? "bg-white text-neutral-900 shadow-sm" : "text-neutral-500 hover:text-neutral-700"}`}
            >
              Monthly
            </button>
            <button
              onClick={() => setAnnual(true)}
              className={`px-4 py-2 text-sm font-medium rounded-md transition-all flex items-center gap-2 ${annual ? "bg-white text-neutral-900 shadow-sm" : "text-neutral-500 hover:text-neutral-700"}`}
            >
              Annual
