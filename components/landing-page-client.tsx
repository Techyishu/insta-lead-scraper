...
function Pricing() {
  const plans = [
    ...
    },
    {
      ...
      popular: false,
      features: ["5,000 credits/month", "Everything in Free", "Email support", "Bulk export"],
      cta: "Choose Starter",
    ...
    },
    {
      ...
      popular: true,
      features: ["10,000 credits/month", "Bulk processing", "Priority support", "Unlimited saved searches"],
      cta: "Choose Growth",
